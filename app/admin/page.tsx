...
export default async function AdminPage() {
  ...
  const following = inquiries.filter((i) => i.status === "in_progress").length;
  ...
  return (
    <Shell>
      ...
      <div className="grid four">
        <div className="card pad"><h3>Total</h3><b>{total}</b></div>
        <div className="card pad"><h3>New</h3><b>{fresh}</b></div>
        <div className="card pad"><h3>In progress</h3><b>{following}</b></div>
